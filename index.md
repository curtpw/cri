...
## [](#master)*Wearable Devices, Neural Networks on Mobile Apps, Controlling IoT*<a name="master"></a>
...
## [](#wearable-device)**Wearable Device Streaming Sensor Data**<a name="wearable-device"></a>
...
## [](#mobile-app)**Mobile App with MLP Neural Network**<a name="mobile-app"></a>
...
## [](#raspberry-pi)**Plasma Globe with Raspberry Pi**<a name="raspberry-pi"></a>
...
## [](#sensors)**Sensors and Arduino**<a name="sensors"></a>
...
## [](#empathy)**Building Group Empathy with Sensors, Wearables and Biofeedback**<a name="empathy"></a>
...
## [](#autism-audio)**Audacious Audio for Autism and ADHD: Environmental Audio Acquisition, Processing and Delivery On a Wearable Device**<a name="autism-audio"></a>
...
## [](#eye-track)**Smart Glasses for the Education and Mental Health**<a name="eye-track"></a>
